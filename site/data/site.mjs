...
export const SITE = {
  ...
  authorNote:
    'A pseudonymous curator working under the copyright of ROLF. Assume one person, a long night, an unreasonable amount of respect for reptiles, and a scythe leaning against the desk.',
  founded: '2026',
  updated: '2026-07-30',
  themeColor: '#07100c',
  accent: '#5fe3a1',
